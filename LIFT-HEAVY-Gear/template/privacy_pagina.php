            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>Dati personali forniti direttamente da te, come nome, indirizzo email, indirizzo di
                            spedizione e numero di telefono.</li>
                        <li>Informazioni relative al pagamento, come dettagli della carta di credito o altri metodi di
                            pagamento.</li>
                        <li>Dati relativi alla tua navigazione sul sito, come l'indirizzo IP, il tipo di dispositivo, il
                            browser utilizzato e le pagine visitate.</li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>Comunicarti aggiornamenti sugli ordini e rispondere alle tue domande.</li>
                        <li>Personalizzare la tua esperienza di acquisto e offrirti contenuti e promozioni pertinenti.
                        </li>
                        <li>Assicurare la sicurezza delle transazioni e prevenire frodi.</li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li>Fornitori di servizi essenziali, come corrieri per la consegna e gestori dei pagamenti.</li>
                        <li>Enti legali, se richiesto dalla legge o per proteggere i nostri diritti.</li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>Revocare il consenso al trattamento dei dati, ove applicabile.</li>
                        <li>Presentare un reclamo presso un'autorità di controllo, come il Garante per la Protezione dei
                            Dati Personali.</li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <address>
                        ...
                        Indirizzo: Via Esempio 123, 47522 Cesena, Italia
                    </address>
                </li>
            </ul>
        </section>